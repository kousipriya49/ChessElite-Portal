...
public class AcademyController {
    ...
    @PostMapping("/")
    public ResponseEntity<Object> createAcademy(@RequestBody AcademyRequest academyRequest) {
        try {
            ...
            // Assuming you have a Base64 encoded picture string in academyRequest.getPicture()
            academyEntity.setPicture(academyRequest.getPicture());
